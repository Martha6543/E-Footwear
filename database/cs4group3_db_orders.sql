...
CREATE TABLE `orders` (
  `price` double unsigned zerofill NOT NULL DEFAULT '0000000000000000000000',
...
INSERT INTO `orders` VALUES (0000000000000000000200,2,1,1,1,2),(0000000000000000000400,2,1,2,1,1),(0000000000000000000100,1,2,3,2,1);
